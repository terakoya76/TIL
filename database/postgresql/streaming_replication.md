...
standby側をbasebackupからrestoreした際のcrash recovery方法を指定する
...
$ /usr/lib/postgresql/10/bin/pg_basebackup -X stream -D /var/lib/postgresql/10/main -h <primary-ip> -U <postgres-user>
